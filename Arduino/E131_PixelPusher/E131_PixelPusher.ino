...
#else
//gziped: 1384 (~57% compression)
#define index_htm_gz_len 1384
static const uint8_t index_htm_gz[] PROGMEM = {
    0x1f, 0x8b, 0x08, 0x00, 0xf8, 0x33, 0x4a, 0x5c, 0x00, 0x03, 0xc5, 0x57,
    ...
    };
#endif
...
struct
{
    ...
    uint16_t noOfUniverses = END_UNIVERSE;
} config;
...
#endif
    dma->Initialize();
    pixel = (uint8_t *)realloc(pixel, ledCount);
}
...
void initE131(void)
{
    ...
    if (e131->begin((unicast_flag) ? E131_UNICAST : E131_MULTICAST, START_UNIVERSE, END_UNIVERSE)) // Listen via Unicast/Multicast
...
void readEEPROM(void)
{
    ...
    END_UNIVERSE = config.noOfUniverses;
#ifdef SERIAL_DEBUG
    Serial.printf("READ>> Mode: %s Start Universe: %d No of Universes: %d", (unicast_flag) ? "unicast" : "multicast", START_UNIVERSE, END_UNIVERSE);
#endif
}
...
void writeEEPROM(void)
{
    ...
    config.noOfUniverses = END_UNIVERSE;
#ifdef SERIAL_DEBUG
    Serial.printf("WRITE>> Mode: %s Start Universe: %d No of Universes: %d", (unicast_flag) ? "unicast" : "multicast", START_UNIVERSE, END_UNIVERSE);
#endif
